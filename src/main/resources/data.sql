...
replace into employee (id, active, email, first_name, last_name, login, password) values ( 1,1,'pietruszkakasia@o2.pl', 'admin' , 'admin','admin','$2a$10$CPUI9dBhGc098R5jPaBuT.zNi1G5.pshSx1kqDEqh2M/5TYYPNqyq');
